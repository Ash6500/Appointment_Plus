                ...
                <div className={'grid md:grid-cols-3 gap-[50px]'}>
                    <div className={'md:col-span-2'}>
                        <div className={'flex items-center gap-5'}>
                            ...
                            <div>
                                <span className={'bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-3 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font font-semibold rounded'}>
                                    Surgeon
                                </span>
                                ...
                                <p className={'text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur imperdiet.</p>
                            </div>
                        </div>
